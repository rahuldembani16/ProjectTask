                    ...
                    <div role="tabpanel">
                        ...
                        <ul role="tablist" class="nav nav-tabs">
                            <li role="presentation" class="active">
                                <a href="#submission" aria-controls="home" role="tab" data-toggle="tab" aria-expanded="false"><h4>Edit Task</h4></a>
                            </li>
                        </ul>
                        <!-- Tab panes-->
                        <?php echo form_open('Dashboard/update_task'); ?>
                            ...
                            <div id="submission" role="tabpanel" class="tab-pane  active">
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        Task Name
                                        <input type="text" class="form-control" value="<?php echo $task_details[0]->task_name ?>"   id="task_name"  name="task_name"  placeholder="Task Name">
                                        ...
                                        <div class="form-group">
                                            Task Description
                                            <textarea class="form-control"   id="task_desciption"  name="task_description" rows="4" cols="50"><?php echo $task_details[0]->task_description ?></textarea>
                                        ...
                                        <input type="hidden" name="task_id" value="<?php echo $task_details[0]->id ?>">
